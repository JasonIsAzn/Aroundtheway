...
builder.Services.AddSingleton(new ChatClient("gpt-4", 
    builder.Configuration["OpenAI:ApiKey"] ?? 
    throw new InvalidOperationException("OpenAI API key is not configured. Add OpenAI:ApiKey to appsettings.json")));
